...
public:
  ...
  void registerPressedReleasedFunction(msgFP f);
...
public:
  ...
  void registerTextEventFunction(msgFP f);
...
public:
  ...
  void registerSliderEventFunction(msgFP f);
...
public:
  ...
  void registerToggledEventFunction(msgFP f);
...
public:
  ...
  void registerSelectionEventFunction(msgFP f);

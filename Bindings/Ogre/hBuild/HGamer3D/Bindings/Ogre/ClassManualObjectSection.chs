...
{- function ~ManualObjectSection -}
{#fun ogre_mnos_destruct as delete 
{ withHG3DClass* `HG3DClass' } -> `()'  #}

{- function getMaterialName -}
{#fun ogre_mnos_getMaterialName as getMaterialName 
{ withHG3DClass* `HG3DClass' ,
 alloc64k- `String' peekCString*} -> `()'  #}

{- function getMaterialGroup -}
{#fun ogre_mnos_getMaterialGroup as getMaterialGroup 
{ withHG3DClass* `HG3DClass' ,
 alloc64k- `String' peekCString*} -> `()'  #}

{- function setMaterialName -}
{#fun ogre_mnos_setMaterialName as setMaterialName 
{ withHG3DClass* `HG3DClass' ,
 withCString* `String' ,
 withCString* `String' } -> `()'  #}

{- function set32BitIndices -}
{#fun ogre_mnos_set32BitIndices as set32BitIndices 
{ withHG3DClass* `HG3DClass' ,
 fromBool `Bool' } -> `()'  #}

{- function get32BitIndices -}
{#fun ogre_mnos_get32BitIndices as get32BitIndices 
{ withHG3DClass* `HG3DClass' ,
 alloca- `Bool' peekBoolUtil*} -> `()'  #}

{- function getMaterial -}
{#fun ogre_mnos_getMaterial as getMaterial 
{ withHG3DClass* `HG3DClass' ,
 alloca- `SharedPtr' peekSharedPtr*} -> `()'  #}

{- function getSquaredViewDepth -}
{#fun ogre_mnos_getSquaredViewDepth as getSquaredViewDepth 
{ withHG3DClass* `HG3DClass' ,
 withHG3DClass* `HG3DClass' ,

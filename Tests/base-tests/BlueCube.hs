...
import HGamer3D.BaseAPI.Graphics3D
import HGamer3D.Graphics3D.Graphics3DSchema as Sc
...
main = do
        ...
        (g3ds, guis, last) <- initHGamer3D "HGamer3D - BlueCube Example" False True True
        
	-- camera position
        camera <- addCamera g3ds (Sc.Camera (Sc.Frustum 5.0 5000.0 (Deg 60)) (Sc.Viewport 0 (Rectangle 0.0 0.0 1.0 1.0) black))

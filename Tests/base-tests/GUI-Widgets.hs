...
import qualified HGamer3D.Graphics3D.Graphics3DSchema as S
...
main = do 
	...
	-- camera position
        camera <- addCamera g3ds (S.Camera (S.Frustum 5.0 5000.0 (Deg 60)) (S.Viewport 0 (Rectangle 0.0 0.0 1.0 1.0) black))
	...
	-- create a shiny blue cube
        cubeFigure <- cube g3ds 0.2 (S.ResourceMaterial "Colours/Blue")

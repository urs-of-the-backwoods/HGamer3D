...
ghc -package HGamer3D -o %1.exe %1.hs "%HG3DPATH%\HGamer3DOgre<VersionOgre>.dll" "%HG3DPATH%\HGamer3DCEGUI<VersionCEGUI>.dll" "%HG3DPATH%\HGamer3DSFML<VersionSFML>.dll" "%HG3DPATH%\HGamer3DBullet<VersionBullet>.dll" "%HG3DPATH%\HGamer3DEnet<VersionEnet>.dll"

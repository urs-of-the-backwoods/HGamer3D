...
{#fun ogre_txmgr_setDefaultNumMipmaps as setDefaultNumMipmaps 
{ withHG3DClass* `HG3DClass' ,
 fromIntegral `Int' } -> `()'  #}

{- function getDefaultNumMipmaps -}
{#fun ogre_txmgr_getDefaultNumMipmaps as getDefaultNumMipmaps 
{ withHG3DClass* `HG3DClass' ,
 alloca- `Int' peekIntConv*} -> `()'  #}

{- function getSingleton -}
{#fun ogre_txmgr_getSingleton as getSingleton 
{ alloca- `HG3DClass' peek*} -> `()'  #}

{- function getSingletonPtr -}
{#fun ogre_txmgr_getSingletonPtr as getSingletonPtr 
{ alloca- `HG3DClass' peek*} -> `()'  #}

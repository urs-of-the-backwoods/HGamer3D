...
void ButtonItem::registerPressedReleasedFunction(msgFP f)
{
    callbackF = f;
}
...
void ButtonItem::HandlePressedReleasedChanged(StringHash eventType, VariantMap& eventData)
{
    if (callbackF != NULL) {
        ...
        callbackF((void*)this, buffer.data(), buffer.size());
    }
}
...
void EditTextItem::registerTextEventFunction(msgFP f)
{
    callbackF = f;
}
...
void SliderItem::registerSliderEventFunction(msgFP f)
{
    callbackF = f;
}
...
void CheckBoxItem::registerToggledEventFunction(msgFP f)
{
    callbackF = f;
}
...
void DropDownListItem::registerSelectionEventFunction(msgFP f)
{
    callbackF = f;
}
